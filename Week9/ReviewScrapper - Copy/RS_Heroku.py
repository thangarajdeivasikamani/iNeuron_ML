...
# Shift + Tab for change the indentation
# Steps
"""
Steps
1. website
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            for commentbox in commentboxes:
                ...
                # Insert the data into table database
...
# Initial point to start executing, we can give URL ,port, debug info
